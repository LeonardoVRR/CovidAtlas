...
function App() {
  ...
  return (
    <div className="w-dvw h-dvh flex flex-col items-center">
      <h1 className="text-5xl">Casos de covid-19 no mundo</h1>
      <article className="w-full h-full grid grid-rows-1 grid-cols-4">
        ...
        >
          ...
          >
            <g className="fill-slate-300 cursor-pointer">
              <path
              ...
              <path
                ...
                id="CI"
                data-countryname="Côte d'Ivoire"
              ></path>
              <path
              ...
              <path
                ...
                id="CG"
                data-countryname="Republic of Congo"
              ></path>
              <path
              ...
              <path
                ...
                id="KR"
                data-countryname="Republic of Korea"
              ></path>
              <path
              ...
              <path
                ...
                id="KP"
                data-countryname="Dem. Rep. Korea"
              ></path>
              <path
              ...
              <path
                ...
                id="SR"
                data-countryname="Suridata-countryname"
              ></path>
              <path
              ...
              ></path>
              <path
                data-countryname="Canary Islands (Spain)"
        ...
        <section
          id="country_info"
          className="col-start-4 bg-slate-400"
        ></section>
      </article>
    </div>
  );
